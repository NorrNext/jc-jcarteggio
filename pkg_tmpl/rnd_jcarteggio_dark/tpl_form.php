...
?>
<h4 class="rnd-clearfix rnd-form-header"><span class="rnd-comments-header"><?php echo JText::_('FORM_HEADER'); ?></span></h4>
<?php
...
<div class="rnd-form-row">
	<label class="rnd-form-label" for="comments-form-name"><?php echo $text; ?></label>
...
?>
<div class="rnd-form-row">
	<label class="rnd-form-label" for="comments-form-email"><?php echo $text; ?></label>
	<div class="rnd-form-controls">
...
?>
<div class="rnd-form-row">
	<label class="rnd-form-label" for="comments-form-homepage"><?php echo $text; ?></label>
	<div class="rnd-form-controls">
...
?>
<div class="rnd-form-row">
	<label class="rnd-form-label" for="comments-form-title"><?php echo $text; ?></label>
	<div class="rnd-form-controls">
...
<div class="rnd-form-row">
	<label class="rnd-form-label" for="comments-form-subscribe"><?php echo JText::_('FORM_SUBSCRIBE'); ?></label>
...
<div id="comments-form-buttons" class="rnd-margin-small-top rnd-margin-small-bottom rnd-clearfix" data-rnd-margin>
	<div class="rnd-float-left rnd-margin-small-right" id="comments-form-send">
		<div>
			<a class="rnd-button rnd-button-small rnd-button-primary" href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?></a>
		</div>
	</div>
	<div class="" id="comments-form-cancel" style="display:none;">
		<div>
			<a class="rnd-button rnd-button-small rnd-button-danger" href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a>
		</div>
	</div>
